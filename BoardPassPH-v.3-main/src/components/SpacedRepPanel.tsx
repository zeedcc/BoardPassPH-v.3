...
import { Layers, RotateCw, Smile } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      {profile.deck.length === 0 ? (
        <div className="bg-white border border-dashed border-gray-200 rounded-3xl p-16 text-center text-gray-500 max-w-lg mx-auto select-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {profile.deck.map((item, idx) => {
            ...
            return (
              ...
              >
                <div 
                  className={`relative w-full h-full text-left transition-transform duration-500 preserve-3d shadow-sm hover:shadow-md rounded-2xl border border-gray-250 ${
                ...
                >
                  <div className="absolute inset-0 bg-white p-5 rounded-2xl backface-hidden flex flex-col justify-between overflow-hidden">
                    ...
                    <div className="flex justify-between items-center text-[10px] text-gray-400 border-t border-gray-100 pt-3 select-none">
                      <span className="flex items-center gap-1 font-bold">
                        <RotateCw className="w-3 h-3 text-sage animate-spin-slow" />
                  ...
                  <div className="absolute inset-0 bg-[#f7fbf8] p-5 rounded-2xl backface-hidden rotate-y-180 flex flex-col justify-between overflow-hidden border-2 border-pine/5">
                    <div className="space-y-3 h-full overflow-y-auto no-scrollbar">
                      ...
                      <p className="text-[11px] text-gray-600 leading-relaxed font-sans font-medium whitespace-pre-wrap select-text">
                        {item.explanation}
                      </p>
                    </div>
