...
import { Award, Check, X, Zap, BookOpen, Clock, BrainCircuit, TrendingUp } from 'lucide-react';
...
const COMPARISON_FEATURES: FeatureItem[] = [
  ...
  { 
    ...
    category: 'simulators',
    free: false, 
    trial: '20-item Diagnostic', 
    pro: false, 
    clinical: true 
  },
  { 
    name: 'Group Study Peers Capacity', 
    description: 'Peer coordination limit in live Firebase room connections.',
    category: 'tools',
    free: false, 
    trial: '3 peers limit',
    pro: 'Unlimited', 
  ...
  { 
    name: 'Passing Rate Correlation Forecast', 
    description: 'Interactive correlation models of your simulation scores mapping board success.',
    category: 'tools',
    free: false, 
    trial: 'Simulated averages',
    pro: 'Live personal', 
    clinical: 'Live personal' 
  },
  { 
    ...
    <div className="bg-white border border-pine/10 rounded-2xl p-6 shadow-sm space-y-8 select-none">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-b border-gray-100 pb-5 gap-4">
        <div className="space-y-1">
          ...
          <h3 className="font-display text-xl text-pine mt-1.5 animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gray-50/50 border border-gray-200/60 rounded-xl p-4 space-y-3 relative overflow-hidden">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[10px] text-gray-400 leading-normal">
              Basic features with 5 dynamic clinical AI questions daily.
            </p>
          </div>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3 relative overflow-hidden">
          <div className="flex items-center gap-1.5 text-slate-500">
            ...
            <h4 className="text-[10px] uppercase font-black tracking-wider font-mono">
              7-Day Clinical Trial
            </h4>
          </div>
          <div className="space-y-1.5">
            <div className="text-xl font-display font-bold text-slate-800">₱0 <span className="text-[10px] text-slate-450 font-normal">for 7 days</span></div>
            <p className="text-[10px] text-slate-500 leading-normal">
              Introductory pass containing 10 clinical AI questions daily.
            </p>
          </div>
          <div className="space-y-1 pt-1">
            <div className="flex justify-between items-center text-[8px] font-mono text-slate-500 uppercase font-black">
              <span>Exam Readiness Boost</span>
              <span>25%</span>
            </div>
      ...
      <div className="border border-gray-150 rounded-2xl overflow-hidden shadow-xs">
        <div className="grid grid-cols-12 bg-gray-50 border-b border-gray-150 p-3 text-[10px] font-mono font-black uppercase text-gray-500 select-none">
          <div className="col-span-4 text-left">Feature Details &amp; Objectives</div>
          <div className="col-span-2 text-center border-l border-gray-150">Free</div>
          <div className="col-span-2 text-center border-l border-gray-150">7-Day Trial</div>
          <div className="col-span-2 text-center border-l border-gray-150">Pro Suite</div>
          <div className="col-span-2 text-center border-l border-gray-150">Clinical Suite</div>
        </div>
        ...
        <div className="divide-y divide-gray-100">
          {filteredFeatures.map((feat, fIdx) => (
            <div 
              key={`${feat.name}-${fIdx}`}
              className="grid grid-cols-12 p-3.5 hover:bg-gray-50/50 transition duration-105 items-center gap-1"
            >
              <div className="col-span-4 space-y-0.5 pr-2">
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  {feat.category === 'simulators' && (
                    <span className="text-[7.5px] uppercase font-mono bg-indigo-50 text-[#382B6B] border border-indigo-100 px-1.5 py-0.2 rounded-md font-bold text-center">Simulator</span>
                  )}
                  {feat.category === 'tools' && (
                    <span className="text-[7.5px] uppercase font-mono bg-teal-50 text-teal-800 border border-teal-100 px-1.5 py-0.2 rounded-md font-bold text-center">Workspace Tools</span>
                  )}
                </div>
                <p className="text-[9.5px] text-gray-400 font-mono leading-relaxed max-w-sm">{feat.description}</p>
              </div>

              <div className="col-span-2 text-center border-l border-gray-100/10">
                {renderValue(feat.free, 'free')}
              </div>
              <div className="col-span-2 text-center border-l border-gray-100/10">
                {renderValue(feat.trial, 'free')}
              </div>
              <div className="col-span-2 text-center border-l border-gray-100/10">
                {renderValue(feat.pro, 'pro')}
              </div>
              <div className="col-span-2 text-center border-l border-gray-100/10 col-span-2">
