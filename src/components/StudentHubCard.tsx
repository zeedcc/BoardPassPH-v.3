...
export const StudentHubCard: React.FC<StudentHubCardProps> = ({ profile, onNavigate }) => {
  ...
  const isTrial = profile.tier === 'Clinical Trial' || profile.tier === '7-Day Clinical Trial' || profile.tier === 'Free';

  return (
    <div className="space-y-4 select-none">
      <div className="bg-gradient-to-br from-pine to-[#13271c] border border-pine-light/20 rounded-2xl p-4 text-cream shadow-md relative overflow-hidden">
        ...
        {timeLeft.isOver ? (
          ...
          <div className="grid grid-cols-4 gap-1.5 text-center">
            <div className="bg-[#0b1c14] border border-white/5 rounded-xl p-2">
        ...
        {isTrial ? (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-3 py-2 bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-700 text-white font-sans text-[11px] font-black uppercase tracking-wider rounded-xl transition shadow hover:shadow-md cursor-pointer group"
            >
            ...
            <div className="p-2.5 bg-amber-50/45 border border-amber-100 rounded-xl">
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-[9.5px] text-amber-800/80 leading-normal mt-0.5 font-medium">
